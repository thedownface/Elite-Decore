...
export const POSTS: Post[] = [
  {
    ...
    readTime: '6 min',
    category: 'Materials',
    cover: GALLERY.jaiFortuneKitchenDetail,
    body: [
  ...
  },
  {
    ...
    excerpt:
      'A north-facing room in Bangalore behaves nothing like a north-facing room in Milan. Most imported palettes ignore this.',
    date: '2026-05-02',
    readTime: '8 min',
    category: 'Practice',
    cover: GALLERY.prestige1,
    body: [
      'Indian daylight is high, hard and heavily saturated for most of the year. A palette developed under the soft northern light of a European studio will read entirely differently once it lands in Bengaluru.',
